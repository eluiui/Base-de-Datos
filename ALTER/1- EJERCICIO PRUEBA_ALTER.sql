...
/***    EJERCICIO 14: 
  ...
  ALTER TABLE CURSOS
    ...
    ADD COLUMN DIA_SEMANA ENUM("LUNES","MARTES") NULL,
...
ALTER TABLE PROFESORES
 ...
 CREATE INDEX NOMBRE ON PROFESORES(NOMBRE);
...
DROP INDEX NOMBRE ON PROFESORES;
...
DROP INDEX FK_TUTOR,
ADD UNIQUE INDEX FK_TUTOR(TUTOR);
 /*NO PUEDO BORRARLO Y CREARLO POR SEPARADO */
