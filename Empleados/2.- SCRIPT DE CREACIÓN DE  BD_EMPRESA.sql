...
ALTER TABLE `telefonos_sedes`
  ADD  
     FOREIGN KEY (`SEDE`) REFERENCES `sedes` (`ID_SEDE`) 
           ON DELETE CASCADE ON UPDATE CASCADE;
Alter table empleados_proyectos
add column precio_hora float not null default(110);
...
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-12', `FECHA_FIN` = '2021-12-30', `PRESUPUESTO` = '1000000' WHERE (`ID_PROYECTO` = '1');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-12', `FECHA_FIN` = '2021-12-30', `PRESUPUESTO` = '256000' WHERE (`ID_PROYECTO` = '4');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-12', `FECHA_FIN` = '2021-12-30', `PRESUPUESTO` = '345000' WHERE (`ID_PROYECTO` = '7');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-12', `FECHA_FIN` = '2022-11-13', `PRESUPUESTO` = '1000000' WHERE (`ID_PROYECTO` = '8');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-05', `FECHA_FIN` = '2022-11-13', `PRESUPUESTO` = '650000' WHERE (`ID_PROYECTO` = '2');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-05', `FECHA_FIN` = '2021-12-30', `PRESUPUESTO` = '1000000' WHERE (`ID_PROYECTO` = '6');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2021-01-05', `FECHA_FIN` = '2022-11-13', `PRESUPUESTO` = '123000' WHERE (`ID_PROYECTO` = '3');
UPDATE `empresa`.`PROYECTOS` SET `FECHA_INICIO` = '2020-12-03', `FECHA_FIN` = '2022-11-13', `PRESUPUESTO` = '650000' WHERE (`ID_PROYECTO` = '5');